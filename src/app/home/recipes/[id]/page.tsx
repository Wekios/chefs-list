    ...
    <Box sx={{ p: 2 }}>
      <Sheet sx={{ borderRadius: "sm", mb: 3, minHeight: 500, p: 2 }} variant="outlined">
        ...
        <Typography level="body-sm" mb={2} mt={2}>
          ...
          glaciers, and a lot o biological diversity. It is amazing that almost 95 percent of the
          park is designated wilderness. Yosemite is one of the largest and least fragmented habitat
          blocks in the Serra Nevada, and the park supports a fantastic diversity of plants and
          animals.
          <br />
          <br />
