...
-- CreateEnum
CREATE TYPE "IngredientUnit" AS ENUM ('PIECE', 'KILOGRAM', 'GRAM', 'LITER', 'MILLILITER', 'TEASPOON', 'TABLESPOON', 'CUP', 'PINCH');

-- CreateEnum
CREATE TYPE "IngredientCategory" AS ENUM ('OIL', 'MEAT', 'FRUIT', 'DAIRY', 'SPICE', 'VEGETABLE');
...
-- AddForeignKey
ALTER TABLE "MealIngredient" ADD CONSTRAINT "MealIngredient_recipeId_fkey" FOREIGN KEY ("recipeId") REFERENCES "Recipe"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
